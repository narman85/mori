...
export const Hero: React.FC<HeroProps> = ({ className = '' }) => {
  return (
    <section className={`w-full flex flex-col items-center md:items-start ${className}`}>
      ...
      <img
        ...
        className="aspect-[1.8] object-contain w-full max-w-[800px] mt-[30px] max-md:max-w-full max-md:mt-6 md:max-w-[400px] md:self-start md:ml-0"
      />
    </section>
  );
};
